...
class HistoryAdminTeachersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.historyAdminTeachers.index', compact('historyAdminTeachers'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.historyAdminTeachers.create');
    }
    ...
    public function store(StoreHistoryAdminTeacherRequest $request)
    {
        ...
        return redirect()->route('admin.history-admin-teachers.index');
    }
    ...
    public function edit(HistoryAdminTeacher $historyAdminTeacher)
    {
        ...
        return view('admin.historyAdminTeachers.edit', compact('historyAdminTeacher'));
    }
    ...
    public function show(HistoryAdminTeacher $historyAdminTeacher)
    {
        ...
        return view('admin.historyAdminTeachers.show', compact('historyAdminTeacher'));
    }
