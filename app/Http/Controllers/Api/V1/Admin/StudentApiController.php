...
class StudentApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new StudentResource(Student::with(['classroom', 'school', 'academic_years', 'email', 'roles'])->get());
    }
    ...
    public function show(Student $student)
    {
        ...
        return new StudentResource($student->load(['classroom', 'school', 'academic_years', 'email', 'roles']));
    }
