...
@can('academic_year_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.academic-years.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AcademicYear">
            <thead>
                <tr>
                    <th width="10">
...
@can('academic_year_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.academic-years.massDestroy') }}",
