...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.annoucements.update", [$annoucement->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="annoucement">{{ trans('cruds.annoucement.fields.annoucement') }}</label>
                <div class="needsclick dropzone {{ $errors->has('annoucement') ? 'is-invalid' : '' }}" id="annoucement-dropzone">
                </div>
                @if($errors->has('annoucement'))
                    <span class="text-danger">{{ $errors->first('annoucement') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $annoucement->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $annoucement->number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_name') ? 'is-invalid' : '' }}" type="text" name="short_name" id="short_name" value="{{ old('short_name', $annoucement->short_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('allow_date') ? 'is-invalid' : '' }}" type="text" name="allow_date" id="allow_date" value="{{ old('allow_date', $annoucement->allow_date) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $annoucement->description) !!}</textarea>
...
<script>
    ...
    url: '{{ route('admin.annoucements.storeMedia') }}',
    maxFilesize: 4, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
