    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-classroomSubjects">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($subjects as $key => $subject)
                            <tr data-entry-id="{{ $subject->id }}">
                                ...
                                <td>
                                    @foreach($subject->classrooms as $key => $item)
                                        <span class="badge badge-info">{{ $item->class_room }}</span>
                                    @endforeach
                                </td>
                                <td>
                                    @can('subject_show')
...
@endcan
  ...
  let table = $('.datatable-classroomSubjects:not(.ajaxTable)').DataTable({ buttons: dtButtons })
