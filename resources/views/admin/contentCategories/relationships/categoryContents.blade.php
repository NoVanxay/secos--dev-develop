    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-categoryContents">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <tr data-entry-id="{{ $content->id }}">
                                ...
                                <td>
                                    @foreach($content->categories as $key => $item)
                                        <span class="badge badge-info">{{ $item->content_category }}</span>
                                    @endforeach
                                </td>
                                <td>
                                    {{ $content->title ?? '' }}
...
@endcan
  ...
  let table = $('.datatable-categoryContents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
