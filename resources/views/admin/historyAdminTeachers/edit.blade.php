...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.history-admin-teachers.update", [$historyAdminTeacher->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.historyAdminTeacher.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $historyAdminTeacher->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fist_name') ? 'is-invalid' : '' }}" type="text" name="fist_name" id="fist_name" value="{{ old('fist_name', $historyAdminTeacher->fist_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $historyAdminTeacher->last_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eng_name') ? 'is-invalid' : '' }}" type="text" name="eng_name" id="eng_name" value="{{ old('eng_name', $historyAdminTeacher->eng_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eng_last') ? 'is-invalid' : '' }}" type="text" name="eng_last" id="eng_last" value="{{ old('eng_last', $historyAdminTeacher->eng_last) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $historyAdminTeacher->date_of_birth) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text') ? 'is-invalid' : '' }}" type="text" name="text" id="text" value="{{ old('text', $historyAdminTeacher->text) }}" required>
                @if($errors->has('text'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tribes') ? 'is-invalid' : '' }}" type="text" name="tribes" id="tribes" value="{{ old('tribes', $historyAdminTeacher->tribes) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('pabbajja') ? 'is-invalid' : '' }}" type="text" name="pabbajja" id="pabbajja" value="{{ old('pabbajja', $historyAdminTeacher->pabbajja) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identification_card') ? 'is-invalid' : '' }}" type="text" name="identification_card" id="identification_card" value="{{ old('identification_card', $historyAdminTeacher->identification_card) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('village_birth') ? 'is-invalid' : '' }}" type="text" name="village_birth" id="village_birth" value="{{ old('village_birth', $historyAdminTeacher->village_birth) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_village') ? 'is-invalid' : '' }}" type="text" name="current_village" id="current_village" value="{{ old('current_village', $historyAdminTeacher->current_village) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('temple') ? 'is-invalid' : '' }}" type="text" name="temple" id="temple" value="{{ old('temple', $historyAdminTeacher->temple) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_no_1') ? 'is-invalid' : '' }}" type="number" name="phone_no_1" id="phone_no_1" value="{{ old('phone_no_1', $historyAdminTeacher->phone_no_1) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_no_2') ? 'is-invalid' : '' }}" type="number" name="phone_no_2" id="phone_no_2" value="{{ old('phone_no_2', $historyAdminTeacher->phone_no_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_phone') ? 'is-invalid' : '' }}" type="number" name="office_phone" id="office_phone" value="{{ old('office_phone', $historyAdminTeacher->office_phone) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('census') ? 'is-invalid' : '' }}" type="text" name="census" id="census" value="{{ old('census', $historyAdminTeacher->census) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('allow_date') ? 'is-invalid' : '' }}" type="text" name="allow_date" id="allow_date" value="{{ old('allow_date', $historyAdminTeacher->allow_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('live_at') ? 'is-invalid' : '' }}" type="text" name="live_at" id="live_at" value="{{ old('live_at', $historyAdminTeacher->live_at) }}" required>
