    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.policies.update", [$policy->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('policy') ? 'is-invalid' : '' }}" id="policy-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $policy->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lavel_no') ? 'is-invalid' : '' }}" type="text" name="lavel_no" id="lavel_no" value="{{ old('lavel_no', $policy->lavel_no) }}" required>
                @if($errors->has('lavel_no'))
                    <span class="text-danger">{{ $errors->first('lavel_no') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('allow_date') ? 'is-invalid' : '' }}" type="text" name="allow_date" id="allow_date" value="{{ old('allow_date', $policy->allow_date) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $policy->description) !!}</textarea>
