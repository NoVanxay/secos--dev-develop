...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Policy">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'id', name: 'id' },
{ data: 'policy', name: 'policy', sortable: false, searchable: false },
{ data: 'name', name: 'name' },
{ data: 'lavel_no', name: 'lavel_no' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Policy').DataTable(dtOverrideGlobals);
