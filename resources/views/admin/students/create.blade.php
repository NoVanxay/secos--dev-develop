    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.students.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('st_code') ? 'is-invalid' : '' }}" type="text" name="st_code" id="st_code" value="{{ old('st_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father_no') ? 'is-invalid' : '' }}" type="number" name="father_no" id="father_no" value="{{ old('father_no', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mother_no') ? 'is-invalid' : '' }}" type="number" name="mother_no" id="mother_no" value="{{ old('mother_no', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('classroom') ? 'is-invalid' : '' }}" name="classroom_id" id="classroom_id" required>
                    @foreach($classrooms as $id => $classroom)
                        <option value="{{ $id }}" {{ old('classroom_id') == $id ? 'selected' : '' }}>{{ $classroom }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('school') ? 'is-invalid' : '' }}" name="school_id" id="school_id" required>
                    @foreach($schools as $id => $school)
                        <option value="{{ $id }}" {{ old('school_id') == $id ? 'selected' : '' }}>{{ $school }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_from') ? 'is-invalid' : '' }}" type="text" name="end_from" id="end_from" value="{{ old('end_from', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="number" name="phone_no" id="phone_no" value="{{ old('phone_no', '') }}" step="1">
