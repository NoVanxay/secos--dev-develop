                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.books.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="publisher" id="publisher" value="{{ old('publisher', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="page" id="page" value="{{ old('page', '') }}" step="1" required>
                            @if($errors->has('page'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('page') }}
                                </div>
