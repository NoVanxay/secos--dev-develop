    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.class-rooms.update", [$classRoom->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="class_room">{{ trans('cruds.classRoom.fields.class_room') }}</label>
                            <input class="form-control" type="text" name="class_room" id="class_room" value="{{ old('class_room', $classRoom->class_room) }}" required>
