    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.content-categories.update", [$contentCategory->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="content_category">{{ trans('cruds.contentCategory.fields.content_category') }}</label>
                            <input class="form-control" type="text" name="content_category" id="content_category" value="{{ old('content_category', $contentCategory->content_category) }}" required>
