    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.history-admin-teachers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fist_name" id="fist_name" value="{{ old('fist_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="eng_name" id="eng_name" value="{{ old('eng_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="eng_last" id="eng_last" value="{{ old('eng_last', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tribes" id="tribes" value="{{ old('tribes', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="pabbajja" id="pabbajja" value="{{ old('pabbajja') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="identification_card" id="identification_card" value="{{ old('identification_card', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="district_birth" id="district_birth" value="{{ old('district_birth', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="village_birth" id="village_birth" value="{{ old('village_birth', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="current_district" id="current_district" value="{{ old('current_district', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="current_village" id="current_village" value="{{ old('current_village', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="temple" id="temple" value="{{ old('temple', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="phone_no_1" id="phone_no_1" value="{{ old('phone_no_1', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="phone_no_2" id="phone_no_2" value="{{ old('phone_no_2', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="office_phone" id="office_phone" value="{{ old('office_phone', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="census" id="census" value="{{ old('census', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="allow_date" id="allow_date" value="{{ old('allow_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="live_at" id="live_at" value="{{ old('live_at', '') }}" required>
