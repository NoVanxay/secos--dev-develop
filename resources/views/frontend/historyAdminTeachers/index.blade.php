        ...
        <div class="col-md-12">
            @can('history_admin_teacher_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.history-admin-teachers.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $historyAdminTeacher->id }}">
                                        ...
                                        <td>
                                            @can('history_admin_teacher_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.history-admin-teachers.show', $historyAdminTeacher->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('history_admin_teacher_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.history-admin-teachers.edit', $historyAdminTeacher->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('history_admin_teacher_delete')
                                                <form action="{{ route('frontend.history-admin-teachers.destroy', $historyAdminTeacher->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('history_admin_teacher_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.history-admin-teachers.massDestroy') }}",
