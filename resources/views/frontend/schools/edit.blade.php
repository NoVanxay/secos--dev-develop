    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.schools.update", [$school->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="school">{{ trans('cruds.school.fields.school') }}</label>
                            <input class="form-control" type="text" name="school" id="school" value="{{ old('school', $school->school) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="village" id="village" value="{{ old('village', $school->village) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="district" id="district" value="{{ old('district', $school->district) }}" required>
