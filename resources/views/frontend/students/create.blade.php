                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.students.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="st_code" id="st_code" value="{{ old('st_code', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Student::GENDER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="gender_{{ $key }}" name="gender" value="{{ $key }}" {{ old('gender', '2') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="father_no" id="father_no" value="{{ old('father_no', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mother_no" id="mother_no" value="{{ old('mother_no', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="end_from" id="end_from" value="{{ old('end_from', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="phone_no" id="phone_no" value="{{ old('phone_no', '') }}" step="1">
