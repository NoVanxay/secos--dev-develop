                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('history_admin_teacher_access')
                                        <a class="dropdown-item" href="{{ route('frontend.history-admin-teachers.index') }}">
                                            {{ trans('cruds.historyAdminTeacher.title') }}
                                        </a>
                                    @endcan
                                    @can('academic_year_access')
                                        <a class="dropdown-item" href="{{ route('frontend.academic-years.index') }}">
                                    ...
                                    @endcan
                                    @can('school_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.schools.index') }}">
                                    ...
                                    @endcan
                                    @can('content_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.contents.index') }}">
                                            {{ trans('cruds.content.title') }}
                                        </a>
                                    @endcan
                                    @can('annoucement_access')
                                        <a class="dropdown-item" href="{{ route('frontend.annoucements.index') }}">
                                            {{ trans('cruds.annoucement.title') }}
                                        </a>
                                    @endcan
                                    @can('policy_access')
                                        <a class="dropdown-item" href="{{ route('frontend.policies.index') }}">
                                    ...
                                    @endcan
                                    @can('textbook_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.textbooks.index') }}">
                                            {{ trans('cruds.textbook.title') }}
                                        </a>
                                    @endcan
                                    @can('manual_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.manuals.index') }}">
                                            {{ trans('cruds.manual.title') }}
                                        </a>
                                    @endcan
                                    @can('template_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.templates.index') }}">
